...
const ProductCard = ({ img, title, text, price }) => {
  return (
    ...
    <div className="bg-white rounded-xl hover:shadow-xl transition-shadow duration-300 p-5 flex flex-col items-center text-center max-w-sm mx-auto border border-gray-100">
