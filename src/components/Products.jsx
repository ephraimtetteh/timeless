...
export const ProductCard = ({ img, title, text, price }) => {
  return (
    ...
    <div className="p-2 flex flex-col items-center text-center max-w-sm m-auto border border-gray-100">
      ...
      <div className="w-full overflow-hidden rounded-lg">
        <img
          className="rounded-lg w-[400px] h-[300px] object-cover object-center transition-transform duration-300 hover:scale-105"
          src={img} 
          alt={title}
      ...
      <div className="w-full mt-auto">
        ...
        <button 
          className="w-full py-2  bg-pink-500 text-white rounded  hover:bg-pink-700 transition duration-150"
